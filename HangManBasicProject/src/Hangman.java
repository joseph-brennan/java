...
/**
 * Hangman implements the HangmanManager.
...
public class Hangman implements HangmanManager {
    ...
    Hangman(final List<String> dictionary, final int length, final int max)
        ...
        String word = givenDictionary.toArray()
                [rndW.nextInt(givenDictionary.size())].toString();

        this.givenDictionary.removeAll(givenDictionary);

        this.givenDictionary.add(word);
